//Imports des modules
var jwt = require("jsonwebtoken"); // créer des token(jetons) qui permettent l’échange et la vérification de données entre interlocuteurs
var express = require("express");
var md5 = require("md5"); // “Hashage” des mots de passe;
